...
################
# get data
df = pd.DataFrame.from_csv('./data/399300_050408_170731.csv')
# print(df.head())
...
for ui in range(num_unrollings):
    ...
    train_outputs.append(tf.placeholder(tf.float32, shape=[
                         batch_size, 1], name='train_outputs_%d' % ui))
...
test_points_seq = np.arange(2500, 2900, 25).tolist()
...
start_alpha = 0.25
alpha = np.arange(start_alpha, 1.1, (1.0-start_alpha) /
                  len(predictions_over_time[::3]))
